...
SPUNIT_OUTPUT_FILES=$(call spunit_make_output_files,$(SPUNIT_SOURCE_FILES),$(SPUNIT_SOURCE_DIRECTORY)/%,$(SPUNIT_BUILD_DIRECTORY)/source/%)
SPUNIT_DEPENDENCY_FILES=$(call spunit_make_dependency_files,$(SPUNIT_SOURCE_FILES),$(SPUNIT_SOURCE_DIRECTORY)/%,$(SPUNIT_BUILD_DIRECTORY)/source/%)
SPUNIT_EXAMPLE_OUTPUT_FILES=$(call spunit_make_output_files,$(SPUNIT_EXAMPLE_SOURCE_FILES),$(SPUNIT_EXAMPLES_DIRECTORY)/%,$(SPUNIT_BUILD_DIRECTORY)/examples/%)
SPUNIT_EXAMPLE_DEPENDENCY_FILES=$(call spunit_make_dependency_files,$(SPUNIT_EXAMPLE_SOURCE_FILES),$(SPUNIT_EXAMPLES_DIRECTORY)/%,$(SPUNIT_BUILD_DIRECTORY)/examples/%)

$(call spunit_make_build_cpp_target,$(SPUNIT_SOURCE_DIRECTORY),$(SPUNIT_BUILD_DIRECTORY)/source)
